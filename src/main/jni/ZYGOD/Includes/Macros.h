...
#include <ZYGOD/And64InlineHook/And64InlineHook.hpp>

#else //Compile for armv7 lib only. Do not worry about greyed out highlighting code, it still works
#include <ZYGOD/Important/SubstrateHook.h>
#include <ZYGOD/Important/CydiaSubstrate.h>
...
#define HOOK(offset, ptr, orig) hook((void *)getAbsoluteAddress("libil2cpp.so", string2Offset(OBFUSCATE(offset))), (void *)ptr, (void **)&orig)
